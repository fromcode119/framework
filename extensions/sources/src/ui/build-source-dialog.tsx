...
import type { IBuildSourceDialogProps } from '@plugin/src/ui/interfaces/build-source-dialog-props.interface';

/** Modal shell for the build-source forms. Escape closes; the body is portalled to `document.body`. */
export class BuildSourceDialog extends PluginComponent {
