...
import type { BackupsPageClientViewProps } from './backups-page-client-view.interfaces';
 ...
 */
export class BackupsPageClientView extends React.Component<BackupsPageClientViewProps> {
  render(): React.ReactElement {
    const { theme, controller } = this.props;
