...
import type { EditCollectionNotFoundProps } from './edit-collection-not-found.interfaces';

export class EditCollectionNotFound extends React.Component<EditCollectionNotFoundProps> {
