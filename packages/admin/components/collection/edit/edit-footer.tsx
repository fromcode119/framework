...
import type { EditFooterProps } from './edit-footer.interfaces';

export class EditFooter extends React.Component<EditFooterProps> {
  render(): React.ReactNode {
    const { collection, theme, isNew, discardHref, handleSubmit, changeSummary, setChangeSummary, saving, router } = this.props;
    return (
