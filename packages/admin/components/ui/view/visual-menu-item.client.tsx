...
export class VisualMenuItem extends PureReactor {
  ...
  @prop declare renderFieldInput: (f: any, item: any, index: number) => React.ReactNode;
  @prop declare onIndent: (index: number, direction: HorizontalAlign) => void;
  @prop declare onRemove: (index: number) => void;

  render(): React.ReactNode {
    const { field, item, index, theme, renderFieldInput, onIndent, onRemove } = this;
      ...
      >
          ...
          <div className={`flex-1 p-2 rounded-xl border flex items-center gap-2 transition-all ${
              ...
              <div className="flex items-center gap-0.5 opacity-20 group-hover:opacity-100 transition-opacity">
                  <button
                      onClick={() => onIndent(index, HorizontalAlign.LEFT)}
                  ...
                  <button
                      onClick={() => onIndent(index, HorizontalAlign.RIGHT)}
