import { FooterAccent } from '@/components/ui/enums/footer-accent.enum';
...
export class AdminPageFooter extends PureReactor {
  ...
  @prop declare links: Array<{ label: string; href: string }>;
  @prop declare accent?: FooterAccent;

  render(): ReactNode {
    const label = this.label;
    const description = this.description;
    const links = this.links;
    const accent = this.accent ?? 'indigo';
    const accentClasses =
      accent === FooterAccent.EMERALD
