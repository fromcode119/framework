 ...
 *
 * A site's pages — anything a plugin serves inside a site — are not part of
...
export class SiteScopeGate extends AdminComponent {
  ...
  /** The page's path, named in the sentence: "/<plugin>/<collection> is not part of the platform." */
