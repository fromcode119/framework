...
export default class SecondarySidebarPanelBody extends React.Component<SecondarySidebarPanelBodyProps> {
  ...
  render(): React.ReactNode {
    ...
    return (
    <nav className="min-h-0 flex-1 overflow-y-auto px-3 py-4" aria-label="Secondary navigation" onKeyDown={props.onListKeyDown} onMouseEnter={props.onMouseEnter} onMouseLeave={props.onMouseLeave}>
