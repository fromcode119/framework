          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:flex flex-col items-end pr-4 border-r border-slate-100 dark:border-slate-800">
                ...
                <span className="text-[11px] font-bold text-indigo-600 dark:text-indigo-400">Authenticated via UI</span>
              </div>
              <div className="px-5 py-3 rounded-2xl border flex items-center gap-3 text-[11px] font-black uppercase tracking-widest shadow-sm transition-all hover:scale-[1.02] bg-white border-slate-100 text-slate-500 hover:text-indigo-600 hover:shadow-indigo-500/5 dark:bg-slate-900 dark:border-slate-800 dark:text-slate-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-900/40 dark:text-slate-400">Content Collections</h3>
            ...
            <div className="flex items-center gap-4">
              <div className="h-8 w-1.5 rounded-full bg-indigo-600 dark:bg-indigo-500/40"></div>
              <h3 className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-900/40 dark:text-slate-400">Recent Activity</h3>
              <div className="h-px flex-1 bg-slate-200/60 dark:bg-slate-800"></div>
            </div>
            ...
            <Card noPadding className="overflow-hidden border-0 bg-white shadow-[0_20px_50px_-20px_rgba(0,0,0,0.05)] ring-1 ring-slate-100 dark:bg-transparent dark:shadow-none dark:ring-0">
              <div className="flex items-center justify-between px-8 py-6 border-b border-slate-100 dark:border-slate-800">
                 <div>
                  <h3 className="font-black uppercase tracking-tight text-lg text-slate-900 dark:text-white">System Events</h3>
                 ...
                 <Button 
                   ...
                   className="text-[10px] font-black uppercase tracking-[0.15em] px-4 group text-indigo-600 bg-indigo-50/50 hover:bg-indigo-600 hover:text-white rounded-xl transition-all dark:text-indigo-400 dark:bg-transparent dark:hover:bg-slate-800"
                 >
                    ...
                    <div key={item.id} className="px-8 py-5 flex items-start gap-4 group transition-all duration-300 hover:bg-indigo-50/30 dark:hover:bg-slate-800/30">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-4">
                          <p className="text-[13px] font-bold truncate leading-relaxed text-slate-700 group-hover:text-slate-900 dark:text-slate-200 dark:group-hover:text-white">
                            {item.title}
                          </p>
                          <span className="text-[9px] font-black uppercase tracking-[0.1em] whitespace-nowrap px-2 py-1 rounded-md bg-slate-100 text-slate-400 dark:bg-slate-800 dark:text-slate-500">
