...
/**
 * The last step: the address this console will answer on.
 *
 * PREFILLED, NOT INVENTED. The value is the origin you are standing on — the address you just used
 * to reach this page — so it is something the operator demonstrably chose, not a guess the platform
 * made up. It is shown and editable rather than written silently, because it decides what the
 * gateway routes by from the next request onward: get it wrong and the console you are told to go to
 * is the one address that does not answer.
 *
 * Only this one is asked for. A site's address belongs to the site and is set when the site is
    ...
    return (
      <div className="space-y-5">
        {/*
          ...
          * submitted, anyone who can reach this address can claim this platform — that is true of
