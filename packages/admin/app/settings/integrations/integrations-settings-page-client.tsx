...
export function IntegrationsSettingsPageClient() {
  ...
  const [resettingStaleJs, setResettingStaleJs] = useState(false);
  ...
  const activeProviders = useMemo(() => activeIntegration?.storedProviders || [], [activeIntegration]);
  ...
  }, [activeIntegration, selectedProviderId]);
  ...
  const handleResetStaleJavaScript = async () => {
    if (typeof window === 'undefined') return;

    setResettingStaleJs(true);
  ...
  }, [activeIntegration, selectedProviderDefinition, selectedProviderId, editor?.isNew]);
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          ...
          <div className="flex w-full flex-col gap-3 lg:w-auto lg:min-w-[520px] lg:flex-row lg:items-center lg:justify-end">
            ...
            <Button
              ...
              onClick={() => void handleResetStaleJavaScript()}
            ...
            {!editor ? (
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-end gap-2 pt-2">
                  {editor.isNew ? (
                    <Button type="button" variant="secondary" onClick={cancelNewProvider}>
                      Cancel
                    </Button>
                  ) : (
