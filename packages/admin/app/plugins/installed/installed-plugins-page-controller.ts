...
import type {
  ...
  InstalledPluginsArchiveInspection,
  PluginReapprovalEntry,
...
export class InstalledPluginsPageController {
  ...
  static async fetchPlugins(): Promise<LoadedPlugin[]> {
   ...
   */
  static async fetchMarketplace(): Promise<InstalledPluginMarketplaceItem[]> {
    ...
    const registry = result as { plugins?: InstalledPluginMarketplaceItem[] };
  ...
  ): Promise<InstalledPluginsArchiveInspection> {
  ...
  static async installArchive(uploadId: string, onStatus: (status: PluginInstallOperation | null) => void): Promise<void> {
  ...
  static async installFromMarketplace(slug: string, onStatus: (status: PluginInstallOperation | null) => void): Promise<void> {
  ...
  static async deletePlugin(slug: string, plugins: LoadedPlugin[]): Promise<void> {
  ...
  static filterPlugins(plugins: LoadedPlugin[], searchQuery: string): LoadedPlugin[] {
  ...
  static deleteConfirmDescription(pluginToDelete: string | null, plugins: LoadedPlugin[]): string {
