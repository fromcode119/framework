        ...
        <div className="flex items-center gap-3">
          {installed && !hasUpdate ? (
            <button
              ...
              className={`w-full flex items-center justify-center gap-2.5 h-9 rounded-lg text-[10px] font-bold uppercase tracking-wide transition-all ${theme === 'dark' ? 'bg-slate-800 text-slate-400 hover:text-white' : 'bg-slate-50 text-slate-400 hover:bg-slate-100 hover:text-slate-600'}`}
            >
