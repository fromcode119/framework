...
import type { NewRolePermissionsCardProps } from './new-role-permissions-card.interfaces';

export class NewRolePermissionsCard extends React.Component<NewRolePermissionsCardProps> {
