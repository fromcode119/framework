        ...
        <div className={`sticky top-0 z-40 border-b backdrop-blur-3xl ${
          ...
          <div className="w-full px-6 lg:px-12 py-10 flex items-center justify-between">
            <div className="flex items-center gap-6">
              <Link href={AdminConstants.ROUTES.USERS.DETAIL(id)} className={`p-2 rounded-xl transition-all ${theme === 'dark' ? 'hover:bg-slate-800 text-slate-500' : 'hover:bg-slate-50 text-slate-400'}`}>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-2">
                    ...
                    <div className="space-y-2">
                       ...
                       <Input
                          ...
                          onChange={(e) => this.updateForm({ confirmPassword: e.target.value })}
                    ...
                    <div className="space-y-2">
                       ...
                       <div className="flex items-center gap-3">
                          <Button
                            ...
                            onClick={() => this.updateForm({ accountStatus: 'active' })}
                          >
                            Active
                          </Button>
                          <Button
                            ...
                            size="sm"
                            className="rounded-lg"
                            onClick={() => this.updateForm({ accountStatus: 'suspended' })}
                          >
                            Suspended
                          </Button>
                       </div>
                    ...
                    <div className="space-y-2">
                       ...
                       <div className="pt-2">
                         <Switch
                           ...
                           onChange={(checked) => this.updateForm({ forcePasswordReset: checked })}
                         />
                       </div>
                    </div>
                 </div>
