...
export class AdminConstants {
  ...
  PLUGINS: {
    ...
    RUNTIME: (slug: string) => AdminConstants.versionedRoute(SystemConstants.API_PATH.PLUGINS.BASE, RouteConstants.SEGMENTS.PLUGINS_SLUG_RUNTIME, { slug }),
  ...
  SYSTEM: {
    ...
    TENANTS_IMPORT_STANDALONE: AdminConstants.v(SystemConstants.API_PATH.SYSTEM.ADMIN_TENANTS_IMPORT_STANDALONE),
