 ...
 *
 * So the alias is resolved at BUILD time, the same way next-build-codegen generates Next's route exports and
 * `TyporSyntaxPlugin` rewrites extended syntax: `typescript-multiple-inheritance-build` swaps alias specifiers for relative ones,
