...
/**
 * `typescript-multiple-inheritance typecheck <packageDir> [--tsconfig tsconfig.json]` — typecheck a package whose source uses
 * typescript-multiple-inheritance's extended syntax.
 *
...
export class TypecheckCommand extends TyporCommand {
  readonly summary = 'Typecheck a package using typescript-multiple-inheritance extended syntax <pkgDir> [--tsconfig x].';
