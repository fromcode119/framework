...
console.log('');
console.log('  1. Auth with GitHub Packages (once per machine):');
console.log('       https://github.com/settings/tokens → New token (classic)');
console.log('       Tick: read:packages  →  copy the token');
console.log('       export GITHUB_TOKEN=ghp_...   (add to ~/.zshrc or ~/.bashrc)');
console.log('');
