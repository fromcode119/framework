...
import type { IBuildResult } from '@sources/services/interfaces/build-result.interface';
import type { IPackageBuiltEvent } from '@sources/services/interfaces/package-built-event.interface';
