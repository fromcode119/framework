// SUPERSEDED by @fromcode119/extension-builder. Deleted in Task 11, once context.extensions exists.
// Do not edit — fix the copy in packages/extension-builder instead.
