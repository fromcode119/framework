 ...
 * (`org.fromcode:ecommerce:order`); `keys` are correlation keys the subject can offer about itself
 ...
 * matching `kind === 'org.fromcode:ecommerce:order'` would be one plugin hardcoding another plugin's
