...
describe('SeederCallableResolver', () => {
  ...
  it('prefers default callable over named allowlist symbols', () => {
    ...
    expect(resolution.symbolName).toBe(SeederCallableSymbol.DEFAULT);
    expect(resolution.sourceType).toBe(SeederCallableSourceType.DEFAULT);
  });
  ...
  it('uses seed when default callable is absent', () => {
    ...
    expect(resolution.symbolName).toBe(SeederCallableSymbol.SEED);
  });
  ...
  it('uses run when default and seed are absent', () => {
    ...
    expect(resolution.symbolName).toBe(SeederCallableSymbol.RUN);
  });
  ...
  it('uses execute when default, seed, and run are absent', () => {
    ...
    expect(resolution.symbolName).toBe(SeederCallableSymbol.EXECUTE);
  });
