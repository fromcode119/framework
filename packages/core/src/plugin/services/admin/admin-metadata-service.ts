...
import { AdminSecondaryPanelGuard } from '@core/plugin/services/admin/admin-secondary-panel-guard';
import { AdminSecondaryPanelGovernanceService } from '@core/plugin/services/admin/admin-secondary-panel-governance-service';
import { AdminSecondaryPanelPrecedenceService } from '@core/plugin/services/admin/admin-secondary-panel-precedence-service';
import { AdminSecondaryPanelResolver } from '@core/plugin/services/admin/admin-secondary-panel-resolver';
