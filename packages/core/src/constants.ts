...
export class SystemConstants {
  ...
  AUTH: {
    ...
    ADMIN_SEND_PASSWORD_RESET: joinPath(AUTH_BASE, ROUTE_SEGMENTS.ADMIN_SEND_PASSWORD_RESET),
  ...
  SYSTEM: {
    ...
    ADMIN_BACKUPS: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS),
    ADMIN_BACKUP: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_ID),
    ADMIN_BACKUP_CREATE_SYSTEM: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_CREATE_SYSTEM),
    ADMIN_BACKUP_IMPORT: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_IMPORT),
    ADMIN_BACKUP_IMPORT_SESSION: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_IMPORT_SESSION),
    ADMIN_BACKUP_IMPORT_CHUNK: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_IMPORT_CHUNK),
    ADMIN_BACKUP_IMPORT_COMPLETE: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_IMPORT_COMPLETE),
    ADMIN_BACKUP_DOWNLOAD: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_ID_DOWNLOAD),
    ADMIN_BACKUP_RESTORE_PREVIEW: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_BACKUPS_ID_RESTORE_PREVIEW),
    ...
    ADMIN_PEOPLE_ID_RECORDS: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_PEOPLE_ID_RECORDS),
    ADMIN_PEOPLE_RECORDS: joinPath(SYSTEM_BASE, ROUTE_SEGMENTS.ADMIN_PEOPLE_RECORDS),
  ...
  PLUGINS: {
    ...
    INSTALL: joinPath(PLUGINS_BASE, ROUTE_SEGMENTS.PLUGINS_INSTALL)
  },
  THEMES: {
    BASE: THEMES_BASE,
    PUBLIC: joinPath(THEMES_BASE, ROUTE_SEGMENTS.THEMES_SLUG_PUBLIC_WILDCARD),
