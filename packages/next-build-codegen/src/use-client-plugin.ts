 ...
 * `next-build-codegen` (the Next/build layer), never in `reactor` (which stays pure React) and never as a loose script.
 *
 *   // build config
...
export class UseClientPlugin {
  ...
  static esbuild(): PluginLike {
    return {
      name: 'next-build-codegen-use-client-from-filename',
