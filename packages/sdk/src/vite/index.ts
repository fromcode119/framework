...
// uses the alias.
export { FromcodeThemeOverridesPlugin } from '@sdk/vite/fromcode-theme-overrides-plugin';
export type { IFromcodeThemeOverridesOptions } from '@sdk/vite/interfaces/fromcode-theme-overrides-options.interface';
