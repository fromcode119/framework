...
// Route files export ONLY the class — Next's GET/HEAD exports are generated by next-build-codegen at build
// time, so tests call the statics directly.
import { FrontendApiProxyRoute } from '@/app/api/[...path]/route';
