...
import { ForgotPasswordPage as ForgotPasswordClient } from '@/app/forgot-password/components/view/forgot-password-client.client';
...
export class ForgotPasswordPageRoute {
  static async render({
    searchParams,
  }: {
