...
export const generateImportMap = () => {
  return {
    imports: {
      ...
      "@fromcode/react": "data:application/javascript,export const { Slot, Override, usePlugins, useTranslation, PluginsProvider, getIcon, createProxyIcon, FrameworkIcons, FrameworkIconRegistry, IconNames } = window.Fromcode;",
