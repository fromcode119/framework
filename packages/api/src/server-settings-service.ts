  ...
  async ensureDefaultSettings() {
    try {
      ...
      const defaults = [
        ...
        { key: SystemConstants.META_KEY.SITE_URL, value: 'http://localhost:3000', description: 'Base URL for the public site.', group: 'General' },
        { key: SystemConstants.META_KEY.FRONTEND_URL, value: 'http://localhost:3000', description: 'The primary URL for your frontend application.', group: 'General' },
        { key: SystemConstants.META_KEY.ADMIN_URL, value: 'http://localhost:3001', description: 'The primary URL for your admin dashboard.', group: 'General' },
