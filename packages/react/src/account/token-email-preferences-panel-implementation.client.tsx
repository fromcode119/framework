...
/**
 * The surface `TokenEmailPreferencesPanel` renders inside its boundary: the same preferences screen for
 * someone who arrived from a link in an email instead of a session.
 *
 ...
 */
export class TokenEmailPreferencesPanelImplementation extends AccountEmailPreferencesPanel {
  protected static readonly registeredAsDefault = TokenEmailPreferencesPanel.implementation.provideDefault(TokenEmailPreferencesPanelImplementation);
