...
export class ContextProviderValueHooks {
  static useContextValue(s: Record<string, any>): PluginContextValue {
    return React.useMemo<PluginContextValue>(() => ({
      ...
      pluginApiSubscription: s.pluginApiSubscription,
