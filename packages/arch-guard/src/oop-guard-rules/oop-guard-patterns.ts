...
export class OopGuardPatterns {
  ...
  // `'use client'` is a BUILD artifact of the `.client.` filename (next-build-codegen's ClientDirectivePlugin injects
  ...
  // GENERATED by next-build-codegen, never authored. `export default function` is already covered by OopGuardPatterns.FC.
  ...
  // `export default class` — Next/Vite required default exports are generated by next-build-codegen, not authored.
