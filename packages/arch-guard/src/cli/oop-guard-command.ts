 ...
 *
 *   arch-guard oop-guard                      # report
 *   FRAMEWORK_OOP_MODE=error arch-guard …     # fail the build on any regression
 *   arch-guard oop-guard --list <bucket>      # print the offenders behind one count
 */
