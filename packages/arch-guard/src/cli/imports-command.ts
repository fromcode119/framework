...
/**
 * `arch-guard imports` — every specifier must resolve, and in-package imports must use the package alias.
 *
 *   arch-guard imports                       # report
 *   ARCHOR_IMPORTS_MODE=error arch-guard …   # fail the build on any finding
 */
